...
public class EntityAcidBall extends EntityArrow implements IProjectile, IEntityAdditionalSpawnData {
	...
	public EntityAcidBall(World worldIn) {
		super(worldIn);
		this.xTile = -1;
		this.yTile = -1;
		this.zTile = -1;
	...
	public EntityAcidBall(World worldIn, EntityLivingBase shooter, float p_i1756_3_) {
		super(worldIn);
